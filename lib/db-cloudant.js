...
function DB(credentials) {
  ...
  console.log("Initialize Cloudant from API Key" + JSON.stringify(credentials));
  console.log("credentials.CLOUDANT_USERNAME"+credentials.CLOUDANT_USERNAME);
  console.log("credentials.CLOUDANT_APIKEY"+credentials.CLOUDANT_APIKEY);
  console.log("credentials.CLOUDANT_URL"+credentials.CLOUDANT_URL);
