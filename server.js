...
if (process.env.binding !== undefined) {
  db_bindings=JSON.parse(process.env.binding);
  console.log("Bindings : "+JSON.stringify(db_bindings));
  process.env.CLOUDANT_USERNAME = db_bindings.username;
  process.env.CLOUDANT_APIKEY = db_bindings.apikey;
  process.env.CLOUDANT_URL = db_bindings.url;
  process.env.CLOUDANT_DATABASE="todos";
  console.log("Cloudand Username : "+process.env.CLOUDANT_USERNAME);
  console.log("Cloudand Apikey : "+process.env.CLOUDANT_APIKEY);
  console.log("Cloudand DB : "+process.env.CLOUDANT_DATABASE);
}
